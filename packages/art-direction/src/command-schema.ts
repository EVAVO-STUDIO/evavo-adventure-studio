...
import {
  artAssetRuleSchema,
  artDirectionProfileSchema,
  type ArtDirectionEditorCommand,
} from "./index.js";

export const artDirectionEditorCommandSchema: z.ZodType<ArtDirectionEditorCommand> =
  z.lazy(() =>
...
export const parseArtDirectionEditorCommand = (
  input: unknown,
): ArtDirectionEditorCommand => artDirectionEditorCommandSchema.parse(input);
