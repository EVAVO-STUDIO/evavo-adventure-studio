import { dialogueGraphSchema, idSchema, sequenceSchema } from "@evavo/adventure-project-schema";
import { z } from "zod";
import type { NarrativeLibraryCommand } from "./index.js";

export const narrativeLibraryCommandSchema: z.ZodType<NarrativeLibraryCommand> = z.lazy(() =>
...
export const parseNarrativeLibraryCommand = (input: unknown): NarrativeLibraryCommand =>
  narrativeLibraryCommandSchema.parse(input);
