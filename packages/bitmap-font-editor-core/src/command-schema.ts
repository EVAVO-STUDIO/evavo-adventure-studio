...
export const bitmapFontEditorCommandSchema: z.ZodType<BitmapFontEditorCommand> = z.lazy(() =>
...
export const parseBitmapFontEditorCommand = (input: unknown): BitmapFontEditorCommand =>
  bitmapFontEditorCommandSchema.parse(input);
