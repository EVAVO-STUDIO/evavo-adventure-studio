...
import { ADVENTURE_CREATIVE_HANDOFF_V3_PROTOCOL_FINGERPRINT } from "./creative-production-protocol-v3.js";
...
const walkFrames = () =>
  Array.from({ length: 8 }, (_, index) => {
    ...
    return {
      ...
      role: number === 1 || number === 5 ? "contact" as const : number === 3 || number === 7 ? "passing" as const : "inbetween" as const,
      exposureTicks: 2,
      pivot: { x: 24, y: 92 },
      footPoint: { x: 24, y: 92 },
      handAnchors: {
...
export const adventureCreativeConformanceStaticOrderV3: AdventureCreativeWorkOrderV3 = {
  contractVersion: 3,
...
export const adventureCreativeConformanceAnimationOrderV3: AdventureCreativeWorkOrderV3 = {
  contractVersion: 3,
...
export const adventureCreativeConformanceFingerprintV3 = (): string =>
  `fnv1a64:${fnv1a64(canonical({
    protocolFingerprint: ADVENTURE_CREATIVE_HANDOFF_V3_PROTOCOL_FINGERPRINT,
    staticOrder: adventureCreativeConformanceStaticOrderV3,
    animationOrder: adventureCreativeConformanceAnimationOrderV3,
  }))}`;

export const ADVENTURE_CREATIVE_CONFORMANCE_V3_FINGERPRINT = "fnv1a64:05f1152e0c6d16c8" as const;
