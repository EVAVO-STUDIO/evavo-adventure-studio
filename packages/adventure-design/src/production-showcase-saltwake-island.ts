...
export const saltwakeIslandShowcase = showcase({
  ...
  plates: [
    ...
    plate(
      ...
      [
        actor(
          ...
          "right",
          "confident point",
          "Large boots, scarf and rolled sleeve survive the reduced gameplay height.",
        ),
        actor(
          "actor.saltwake.harbour-master",
          "npc",
          226,
          154,
          50,
          "left",
          "window lean",
          "Cap, moustache and ledger form a readable comic silhouette.",
        ),
      ],
      [
    ...
    plate(
      ...
      [
        actor(
          "actor.saltwake.apprentice-close",
          "player",
          82,
          164,
          68,
          "right",
          "permit offered",
          "The folded permit and hopeful grin carry the command intent.",
        ),
        actor(
          "actor.saltwake.master-close",
          "npc",
          236,
          160,
          70,
          ...
          "Ledger, cap and raised stamp create the punch-line pose.",
        ),
      ],
      [
    ...
    plate(
      ...
      [
        actor(
          ...
          "right",
          "apprentice marker",
          "A scarf marker shows the planned route origin.",
        ),
      ],
      [
