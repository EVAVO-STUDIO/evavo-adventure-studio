export const adventureCreativeHandoffV3Protocol = {
...
export const adventureCreativeHandoffV3ProtocolFingerprint = (): string =>
  `fnv1a64:${fnv1a64(canonical(adventureCreativeHandoffV3Protocol))}`;

export const ADVENTURE_CREATIVE_HANDOFF_V3_PROTOCOL_FINGERPRINT =
  "fnv1a64:7685192c8eee9542" as const;
