...
describe("Night Shift Foundation technical archive", () => {
  it("is deterministic and contains generated sources plus the complete officer handoff", () => {
    ...
    expect(decoded).toContain("guides/night-shift.officer-art-brief.json");
    expect(decoded).toContain("guides/night-shift.officer-master-guide.png");
    expect(decoded).toContain("guides/night-shift.officer-review-template.json");
